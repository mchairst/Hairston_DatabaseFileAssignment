/*
A company wants to create a database to store employee id, first name, last name and total income. They decided to give 5 characters for id,
 15 characters for first name, 15 characters for last name and 10 characters for income. The table below summarizes the character limits.
...
Complete the code below, make sure it runs correctly. Create a github repository called database, make sure to make the repository public. 
Submit your code to github repository database. Copy the link and paste it on Canvas.
...
/*
The first function we are going to write is ‘search’, 
search takes an employee id and search for that employee in the file, if it 
finds it will return a pointer to the structure ‘Person’ otherwise return null.
*/
